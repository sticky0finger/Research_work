...
%% 读取CSV文件
data1 = readtable('弧形钢板垫高回波结果1.CSV');  
...
% 下表面回波1
plot(n1:n2, sig1, 'b', 'LineWidth', 1.5,'DisplayName', '上表面一次回波');
% 下表面回波2
plot(m:m+L-1,y(m:m+L-1), 'g', 'LineWidth', 1.5,'DisplayName', '下表面一次回波');
hold off;
legend;
